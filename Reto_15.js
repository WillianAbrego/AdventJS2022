/**
 * Una pareja está poniendo el árbol de navidad. El chico es un motivado 
 * de los adornos navideños y quiere que quede perfectamente equilibrado.
...
El árbol de navidad es un triángulo que hay que generar. Ya tienen la base montada,
 que sería la primera fila, y a partir de ahí tienen que ir colocando
...
Las combinaciones también son al revés. Por ejemplo, si abajo es B P,
 arriba es R. Pero también será R si abajo es P B. También si 
 abajo tienes dos veces la misma letra, arriba será la misma letra.
...
Con estas reglas, podríamos ver el árbol que generaríamos con la base B P R P:
 ...
 R B B
B P R P
Escribe un programa que reciba el string B P R P y devuelva un array 
